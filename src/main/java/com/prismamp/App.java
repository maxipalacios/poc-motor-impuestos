...
class App {
  public static void main(String[] args) {
    org.apache.kafka.streams.Topology topology = Topology.build();
    ...
    props.put(StreamsConfig.APPLICATION_ID_CONFIG, "poc-motor");
    props.put(StreamsConfig.BOOTSTRAP_SERVERS_CONFIG, "192.168.0.100:29092");
    ...
    // build the topology
    System.out.println("Starting POC Motor Application");
